...
- You finished implementation ([01 - SDD](01-sdd-workflow.md) or [02 - developer](02-developer.md)) and want **evidence before commit**.
...
6. **Ignoring Fail after code-review Approved** - [code-review](03-code-review.md) may require coverage ≥ threshold when PRD/PLAN sets one. Fix tests first (`developer` / `sdd-develop`), re-run coverage, then commit.
