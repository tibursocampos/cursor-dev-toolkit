...
| [guides/README.md](guides/README.md) | **Daily usage** | Decision tree, step-by-step skill manuals (guides 01-12) |
...
| [PORTABILITY.md](PORTABILITY.md) | Maintainers / porters | Cursor-specific vs reusable contract |
| [DESIGN-DECISIONS.md](DESIGN-DECISIONS.md) | Maintainers | Why Formas, pwsh, no gh, fork-only |
