...
$replacements = [ordered]@{
    ...
    'Handoff to `spec` or `speckit-spec`' = 'Handoff to `sdd-spec` or `speckit-spec`'
    ...
    '| `spec`, `plan`, `sdd-develop`, `speckit-spec`' = '| `sdd-spec`, `sdd-plan`, `sdd-develop`, `speckit-spec`'
    '| `spec`, `plan`, `sdd-develop`' = '| `sdd-spec`, `sdd-plan`, `sdd-develop`'
    'Handoff to `spec` or `speckit-spec` for new spec' = 'Handoff to `sdd-spec` or `speckit-spec` for new spec'
    'LITE** | `spec`, `plan`' = 'LITE** | `sdd-spec`, `sdd-plan`'
    'use `spec` / `plan` / `sdd-develop`' = 'use `sdd-spec` / `sdd-plan` / `sdd-develop`'
