...
A **PLAN** in **pt-BR** at a **canonical** path (`PLAN/PLAN_NNN_*.md` or global). Same `NNN` as PRD. Each step = one `sdd-develop` session. Paths and test names in **English**; no code blocks.
